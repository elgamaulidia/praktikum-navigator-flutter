...
### Home
[![Praktikum Awal - Home](./screenshots/praktikum_awal_home.png)](./screenshots/praktikum_awal_home.png)
Pada praktikum awal, dibuat aplikasi Flutter yang menerapkan perpindahan halaman menggunakan Navigator. Praktikum ini terdiri dari beberapa halaman, yaitu halaman Home, halaman Detail, dan halaman Success.

### Detail
[![Praktikum Awal - Detail](./screenshots/praktikum_awal_detail.png)](./screenshots/praktikum_awal_detail.png)
Halaman Detail menampilkan informasi lanjutan setelah pengguna melakukan navigasi dari halaman Home.

### Success
[![Praktikum Awal - Success](./screenshots/praktikum_awal_success.png)](./screenshots/praktikum_awal_success.png)
...
### Home
[![Perpustakaan - Home](./screenshots/Screenshot_home_perpustakaan.png)](./screenshots/Screenshot_home_perpustakaan.png)
...
### Detail
[![Perpustakaan - Detail](./screenshots/Screenshot_detail_perpustakaan.png)](./screenshots/Screenshot_detail_perpustakaan.png)
Halaman Detail Perpustakaan menampilkan informasi yang lebih lengkap dari fitur atau data yang dipilih oleh pengguna.

### Success
[![Perpustakaan - Success](./screenshots/Screenshot_success_perpustakaan.png)](./screenshots/Screenshot_success_perpustakaan.png)
